...
adapter_path = r"/data/kenenbek/Orpheus-TTS/finetune100/finetuned_model/checkpoint-21400"
...
prompts = [
"Акжол уулу Болотбек сизби?",
"Владимир Болотбеков, сиздин насыя боюнча карыз катталды.",
"Төлөмдү жүргүзүүгө мүмкүнчүлүк тапканыңыз үчүн рахмат. Биз сиздин төлөмдү көзөмөлдөйбүз.",
"Төлөмдү кечиктирүү жоопкерчилик жаратат. Ошондуктан төлөмдү дароо жүргүзүп бериңиз, болбосо чалуулар жана эскертүүлөр кайталана берет.",
"Акча маселелериндеги кыйынчылыктар адамга оор абал жаратканын түшүнөбүз."
]
